...
class Developer:
    def __init__(self):
        ...
        self.skills: dict = {
            ...
            "tools_platforms"         : ["Git", "GitHub", "Axios", "Fabric.js", "ImageKit", "Convex", "Clerk"],
            "data_science_libraries"  : ["OpenCV", "TensorFlow", "Pandas", "Matplotlib"],
        }
...
![ImageKit](https://img.shields.io/badge/ImageKit-%2300BFFF.svg?style=for-the-badge)
